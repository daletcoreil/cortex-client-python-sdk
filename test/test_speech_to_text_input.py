...
class TestSpeechToTextInput(unittest.TestCase):
    """SpeechToTextInput unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpeechToTextInput:
        """Test SpeechToTextInput
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpeechToTextInput`
        """
        model = SpeechToTextInput()
        if include_optional:
    ...
    def testSpeechToTextInput(self):
        """Test SpeechToTextInput"""
