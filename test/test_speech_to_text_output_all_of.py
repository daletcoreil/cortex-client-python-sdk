...
from cortex_client.models.speech_to_text_output_all_of import SpeechToTextOutputAllOf  # noqa: E501
from cortex_client.rest import ApiException

class TestSpeechToTextOutputAllOf(unittest.TestCase):
    """SpeechToTextOutputAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SpeechToTextOutputAllOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = cortex_client.models.speech_to_text_output_all_of.SpeechToTextOutputAllOf()  # noqa: E501
        if include_optional :
            return SpeechToTextOutputAllOf(
                json_format = cortex_client.models.locator.Locator(
                    aws_s3_bucket = 'dalet-AI-bucket', 
                    aws_s3_key = '0000132.mp4', 
                    http_endpoint = '0', ), 
                ttml_format = cortex_client.models.locator.Locator(
                    aws_s3_bucket = 'dalet-AI-bucket', 
                    aws_s3_key = '0000132.mp4', 
                    http_endpoint = '0', ), 
                srt_format = cortex_client.models.locator.Locator(
                    aws_s3_bucket = 'dalet-AI-bucket', 
                    aws_s3_key = '0000132.mp4', 
                    http_endpoint = '0', ), 
                text_format = cortex_client.models.locator.Locator(
                    aws_s3_bucket = 'dalet-AI-bucket', 
                    aws_s3_key = '0000132.mp4', 
                    http_endpoint = '0', ), 
                draftjs_format = cortex_client.models.locator.Locator(
                    aws_s3_bucket = 'dalet-AI-bucket', 
                    aws_s3_key = '0000132.mp4', 
                    http_endpoint = '0', )
            )
    ...
    def testSpeechToTextOutputAllOf(self):
        """Test SpeechToTextOutputAllOf"""
