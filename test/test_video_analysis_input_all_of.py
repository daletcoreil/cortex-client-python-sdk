...
from cortex_client.models.video_analysis_input_all_of import VideoAnalysisInputAllOf  # noqa: E501
from cortex_client.rest import ApiException

class TestVideoAnalysisInputAllOf(unittest.TestCase):
    """VideoAnalysisInputAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test VideoAnalysisInputAllOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = cortex_client.models.video_analysis_input_all_of.VideoAnalysisInputAllOf()  # noqa: E501
        if include_optional :
            return VideoAnalysisInputAllOf(
                input_file = cortex_client.models.locator.Locator(
                    aws_s3_bucket = 'dalet-AI-bucket', 
                    aws_s3_key = '0000132.mp4', 
                    http_endpoint = '', ), 
                output_location = cortex_client.models.locator.Locator(
                    aws_s3_bucket = 'dalet-AI-bucket', 
                    aws_s3_key = '0000132.mp4', 
                    http_endpoint = '', ), 
                data_filter = ["keywords", "ocr", "brands"], 
                language = 'English', 
                start_of_material = 182.6
            )
        else :
            return VideoAnalysisInputAllOf(
                input_file = cortex_client.models.locator.Locator(
    ...
    def testVideoAnalysisInputAllOf(self):
        """Test VideoAnalysisInputAllOf"""
