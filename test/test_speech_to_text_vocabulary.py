...
class TestSpeechToTextVocabulary(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SpeechToTextVocabulary:
        """Test SpeechToTextVocabulary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpeechToTextVocabulary`
        """
        model = SpeechToTextVocabulary()
        if include_optional:
