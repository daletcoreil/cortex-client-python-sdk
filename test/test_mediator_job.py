...
from cortex_client.models.mediator_job import MediatorJob  # noqa: E501
...
class TestMediatorJob(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = cortex_client.models.mediator_job.MediatorJob()  # noqa: E501
        if include_optional :
            return MediatorJob(
                id = '0', 
                date_created = '0', 
                date_modified = '0', 
                quantity = 56, 
                status = cortex_client.models.job_mediator_status.JobMediatorStatus(
                    status = 'NEW', 
                    status_message = '0', 
                    progress = 56, ), 
                job_output = cortex_client.models.job_output.JobOutput(
                    job_output_type = '0', )
            )
        else :
            return MediatorJob(
