...
conf = cortex_client.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self._base_path = "https://svi6ps1cih.execute-api.us-east-1.amazonaws.com/preprod" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("cortex_client")
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'tokenSignature' in self.api_key:
            auth['tokenSignature'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'Authorization',
