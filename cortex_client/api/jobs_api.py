...
class JobsApi(object):
    ...
    def create_job_with_http_info(self, job_mediator_input, **kwargs):  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(MediatorJob, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        if self.api_client.client_side_validation and local_var_params.get('job_mediator_input') is None:  # noqa: E501
