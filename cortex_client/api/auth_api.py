...
class AuthApi:
    ...
    def get_access_token(
        self,
        client: Annotated[StrictStr, Field(description="client_id of the application")],
        secret: Annotated[StrictStr, Field(description="secret_key of the application")],
