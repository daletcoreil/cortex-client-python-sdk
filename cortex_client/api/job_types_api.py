...
class JobTypesApi:
    ...
    def get_all_job_types(
        self,
        project_service_id: Annotated[StrictStr, Field(description="Project service id of the client which associated to the request")],
        ...
        _param = self._get_all_job_types_serialize(
    ...
    @validate_call
    def get_all_job_types_with_http_info(
        self,
        project_service_id: Annotated[StrictStr, Field(description="Project service id of the client which associated to the request")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_all_job_types_without_preload_content(
        self,
        project_service_id: Annotated[StrictStr, Field(description="Project service id of the client which associated to the request")],
        _request_timeout: Union[
            None,
    ...
    def _get_all_job_types_serialize(
        self,
        project_service_id,
        _request_auth,
        _content_type,
        ...
        if project_service_id is not None:
            _header_params['ProjectServiceId'] = project_service_id
