...
class SpeechToTextVocabulary(BaseModel):
    """
    SpeechToTextVocabulary
    """ # noqa: E501
    content: Optional[StrictStr] = None
    sounds_like: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["content", "sounds_like"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sounds_like": obj.get("sounds_like")
        })
        return _obj
