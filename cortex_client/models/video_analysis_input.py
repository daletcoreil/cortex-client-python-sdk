...
class VideoAnalysisInput(JobInput):
    """
    ...
    output_location: Locator = Field(alias="outputLocation")
    data_filter: Optional[List[StrictStr]] = Field(default=None, description="Determine which types of AI analyses are to be indexed.", alias="dataFilter")
    ...
    __properties: ClassVar[List[str]] = ["jobInputType", "inputFile", "outputLocation", "dataFilter", "language", "startOfMaterial"]

    @field_validator('data_filter')
    def data_filter_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        for i in value:
            if i not in set(['audioEffects', 'brands', 'faces', 'keywords', 'labels', 'ocr', 'sentiments', 'shots', 'textualContentModeration', 'transcript', 'visualContentModeration']):
                raise ValueError("each list item must be one of ('audioEffects', 'brands', 'faces', 'keywords', 'labels', 'ocr', 'sentiments', 'shots', 'textualContentModeration', 'transcript', 'visualContentModeration')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "outputLocation": Locator.from_dict(obj["outputLocation"]) if obj.get("outputLocation") is not None else None,
            "dataFilter": obj.get("dataFilter"),
