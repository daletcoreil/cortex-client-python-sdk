...
class VideoAnalysisOutput(JobOutput):
    """
    VideoAnalysisOutput
    """ # noqa: E501
    output_file: Optional[Locator] = Field(default=None, alias="outputFile")
    __properties: ClassVar[List[str]] = ["jobOutputType", "outputFile"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of output_file
        if self.output_file:
            _dict['outputFile'] = self.output_file.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "outputFile": Locator.from_dict(obj["outputFile"]) if obj.get("outputFile") is not None else None
        })
        return _obj
