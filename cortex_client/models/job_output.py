...
class JobOutput(BaseModel):
    ...
    """ # noqa: E501
    job_output_type: StrictStr = Field(alias="jobOutputType")
    __properties: ClassVar[List[str]] = ["jobOutputType"]
    ...
    __discriminator_property_name: ClassVar[str] = 'jobOutputType'

    # discriminator mappings
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'SpeechToTextOutput': 'SpeechToTextOutput','VideoAnalysisOutput': 'VideoAnalysisOutput'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[SpeechToTextOutput, VideoAnalysisOutput]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[SpeechToTextOutput, VideoAnalysisOutput]]:
        """Create an instance of JobOutput from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'SpeechToTextOutput':
            return import_module("cortex_client.models.speech_to_text_output").SpeechToTextOutput.from_dict(obj)
        if object_type ==  'VideoAnalysisOutput':
            return import_module("cortex_client.models.video_analysis_output").VideoAnalysisOutput.from_dict(obj)
