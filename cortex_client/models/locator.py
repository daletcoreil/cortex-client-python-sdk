...
class Locator(BaseModel):
    ...
    """ # noqa: E501
    aws_s3_bucket: StrictStr = Field(description="Name of an AWS S3 bucket", alias="awsS3Bucket")
    aws_s3_key: StrictStr = Field(description="Name of a file in the AWS S3 bucket. For example, name of media file to be indexed in an Input Locator or name of a JSON file in an Output Locator.", alias="awsS3Key")
    http_endpoint: StrictStr = Field(description="Public URL to access the file in the bucket. Must be computed using the AWS SDK method `GeneratePresignedUrl`", alias="httpEndpoint")
    __properties: ClassVar[List[str]] = ["awsS3Bucket", "awsS3Key", "httpEndpoint"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "awsS3Bucket": obj.get("awsS3Bucket"),
            "awsS3Key": obj.get("awsS3Key"),
            "httpEndpoint": obj.get("httpEndpoint")
        })
        return _obj
