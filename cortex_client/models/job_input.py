...
class JobInput(BaseModel):
    ...
    """ # noqa: E501
    job_input_type: StrictStr = Field(alias="jobInputType")
    __properties: ClassVar[List[str]] = ["jobInputType"]
    ...
    __discriminator_property_name: ClassVar[str] = 'jobInputType'

    # discriminator mappings
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'SpeechToTextInput': 'SpeechToTextInput','VideoAnalysisInput': 'VideoAnalysisInput'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[SpeechToTextInput, VideoAnalysisInput]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[SpeechToTextInput, VideoAnalysisInput]]:
        """Create an instance of JobInput from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'SpeechToTextInput':
            return import_module("cortex_client.models.speech_to_text_input").SpeechToTextInput.from_dict(obj)
        if object_type ==  'VideoAnalysisInput':
            return import_module("cortex_client.models.video_analysis_input").VideoAnalysisInput.from_dict(obj)
