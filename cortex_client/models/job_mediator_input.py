...
class JobMediatorInput(BaseModel):
    """
    ...
    """ # noqa: E501
    project_service_id: StrictStr = Field(description="Customer Project ID.  This ID must be provided by Dalet when a Cortex service is provisioned.  It must match the authorization token you have been provided.", alias="projectServiceId")
    quantity: StrictInt = Field(description="Number of units that will be charged for this job.  The unit depends on the job profile.  For example, for an AI metadata extraction job, units are seconds of media duration.")
    tracking: Optional[Dict[str, Any]] = Field(default=None, description="Client metadata associated to the job.  This can include any identification fields provided by the client. It should identify the job in a unique manner and is useful to reconcile usage reports with client metadata.")
    notification_endpoint: Optional[StrictStr] = Field(default=None, description="Callback URL endpoint to be called once the stage of the job is changed.", alias="notificationEndpoint")
    job: Job
    __properties: ClassVar[List[str]] = ["projectServiceId", "quantity", "tracking", "notificationEndpoint", "job"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "projectServiceId": obj.get("projectServiceId"),
            "quantity": obj.get("quantity"),
            "tracking": obj.get("tracking"),
            "notificationEndpoint": obj.get("notificationEndpoint"),
