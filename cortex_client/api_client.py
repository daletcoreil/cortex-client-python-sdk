...
from cortex_client.api_response import ApiResponse, T as ApiResponseT
import cortex_client.models
from cortex_client import rest
from cortex_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(cortex_client.models, klass)
